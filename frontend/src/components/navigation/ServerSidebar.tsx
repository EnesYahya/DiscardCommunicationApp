...
import { ChannelMessageSubscription } from "../../hooks/graphql/server/chat/ChannelMessageSubscription"
import { useAllChannelIds } from "../../hooks/graphql/server/chat/useAllChannelMessageSubscriptions"
...
function ServerSidebar() {
  ...
  const channelIds = useAllChannelIds()
  ...
  return (
    <nav className={classes.nav}>
      {channelIds.map(id => (
        <ChannelMessageSubscription key={id} channelId={id} />
      ))}
